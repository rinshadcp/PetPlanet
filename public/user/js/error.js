...
animate(".moko-404", {
  ...
  frames: 5,
  frameNames:
    "leafO stemO leafN stemN leafM stemM leafL stemL leafK stemK leafJ stemJ leafI stemI leafH leafG stemG leafF stemF leafE stemE leafD stemD leafC stemC leafB stemB leafA stemA eyeL eyeR pupilL pupilR".split(
      " "
    ),
  repeat: true,
  close: true,
